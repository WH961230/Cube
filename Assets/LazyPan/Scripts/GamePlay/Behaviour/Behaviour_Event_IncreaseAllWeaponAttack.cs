...
namespace LazyPan {
    public class Behaviour_Event_IncreaseAllWeaponAttack : Behaviour {
        ...
        public override void DelayedExecute() {
            Cond.Instance.GetData(entity, LabelStr.Assemble(LabelStr.ATTACK, LabelStr.RATIO),
                out FloatData addAttackData);
            Cond.Instance.GetData(Cond.Instance.GetGlobalEntity(), LabelStr.Assemble(LabelStr.ATTACK, LabelStr.RATIO),
