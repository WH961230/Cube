...
namespace LazyPan {
    public class Behaviour_Trigger_ChargeActivationRecoverAllHealth : Behaviour {
        ...
        public Behaviour_Trigger_ChargeActivationRecoverAllHealth(Entity entity, string behaviourSign) : base(entity, behaviourSign) {
