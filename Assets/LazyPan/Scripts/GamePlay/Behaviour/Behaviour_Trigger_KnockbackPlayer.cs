...
namespace LazyPan {
    public class Behaviour_Trigger_KnockbackPlayer : Behaviour {
        private FloatData _damage;
        private Transform _body;
        public Behaviour_Trigger_KnockbackPlayer(Entity entity, string behaviourSign) : base(entity, behaviourSign) {
