...
namespace LazyPan {
    public class Behaviour_Auto_RemoteAttackSelfExplosion : Behaviour {
        ...
        public Behaviour_Auto_RemoteAttackSelfExplosion(Entity entity, string behaviourSign) : base(entity, behaviourSign) {
