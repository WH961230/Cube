...
namespace LazyPan {
    public class Behaviour_Trigger_ChargeActivationPlayerLevelUp : Behaviour {
        ...
        public Behaviour_Trigger_ChargeActivationPlayerLevelUp(Entity entity, string behaviourSign) : base(entity, behaviourSign) {
